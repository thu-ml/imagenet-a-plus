"""
    adapted from https://github.com/hendrycks/natural-adv-examples/blob/master/eval.py

    If you find this useful, please also consider citing:
...
test_transform = trn.Compose(
    [trn.Resize((256,256)), trn.CenterCrop((224,224)), trn.ToTensor(), trn.Normalize(mean, std)])

naes = dset.ImageFolder(root="./imagenet-a-plus/", transform=test_transform)
...
print('ImageNet-A-Plus Accuracy (%):', round(100*acc, 4))
